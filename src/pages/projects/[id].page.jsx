...
function Page({ id }) {
  ...
  const seo = useMemo(
    () => ({
      title: `John Doe — ${currentProject.title}`,
      description: `Look at ${currentProject.title}, a ${currentProject.date} sample project — ${currentProject.company}.`,
      keywords: [`${currentProject.title} project`, `${currentProject.title} development`, `Frontend ${currentProject.title}`, 'Portfolio template'],
    }),
    [currentProject],
  );
