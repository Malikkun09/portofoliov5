...
const SUGGESTIONS = [
  {
    ...
    prompt: 'Describe the image I attached.',
    attach: true,
  },
  {
    id: 'file',
    label: 'Summarize file',
    prompt: 'Summarize the file I attached.',
    attach: true,
  },
  {
    id: 'ask',
    label: 'Ask anything',
    prompt: 'Hi — help me brainstorm a portfolio project idea.',
    attach: false,
  },
];
    ...
    <div className={styles.root}>
      <header className={styles.topBar}>
        <div className={styles.topIdentity}>
          <h1 className={styles.title}>Demo Chat</h1>
      ...
      <div className={styles.dock}>
        <div className={styles.dockInner}>
          ...
          <p className={styles.caption}>
            Media auto-deletes in {purgeMinutes} min
