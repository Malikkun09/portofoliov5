...
function About() {
  ...
  const renderImageContainer = () => (
    <div className={styles.imageContainer}>
      <Image priority src="/giats/front.webp" sizes="100%" fill alt="John Doe" style={{ objectFit: 'cover' }} />
    </div>
  );
    ...
    <section ref={rootRef} className={styles.root}>
      <div className={clsx(styles.nameContainer, 'layout-block-inner')}>
        <AppearTitle>
          ...
          <h1 className={clsx('h1', 'medium')}>John Doe!</h1>
        </AppearTitle>
      </div>
      ...
      <div className={clsx(styles.container, 'layout-grid-inner')}>
        ...
        <div className={clsx(styles.descWrapper)} ref={animatedImageRef}>
          <AppearTitle>
            <div className="p-l">“I build interfaces that feel intentional —</div>
            <div className="p-l">motion, type, and layout working together</div>
            <div className="p-l">to tell a clear story on the web.”</div>
          </AppearTitle>
        </div>
        {!isMobile ? renderImageContainer() : null}
        <div className={clsx(styles.descWrapperBottom)}>
          {!isMobile ? (
            <AppearTitle key="desktop-descWrapperBottom">
              <h6 className="h6">A frontend developer based in San Francisco.</h6>
            ...
            <AppearTitle key="mobile-descWrapperBottom">
              <h6 className="h6">A frontend developer based in San Francisco. With a</h6>
